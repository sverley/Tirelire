 ...
 *
 * **Où il vit, et pourquoi ici**. Deux questions classent un harnais : qui l'a écrit, et
 ...
 * #73 ne crée ni ne change aucune règle, il applique celle que #58 a déjà posée. Case
 ...
 * registre, le registre appartient à la garde, donc une règle. Ce classement était faux :
 * un harnais se classait selon qui l'écrit et contre quel besoin, jamais selon ce que le fichier regarde.
 *
