...
1. Si le besoin demande un harnais : crée la branche, son nom portant le numéro de l'issue
   ...
   registre ou de la garde prend sa forme normale (D81), un fichier de niveau 0 et 1 que le registre
   cite en entier, et un second fichier, hors registre, pour les niveaux 2 à 4. Les trois premières
   ...
   n'en accueille jamais (D81), mets-les dans le second fichier : le codeur n'en voit que le
   verdict.
...
4. Quand le codeur a rendu son compte rendu, vérifie son travail en local, au seuil 2 (`pnpm test
   ...
   l'issue, sans contredire les autres entrées de son catalogue ni les fondamentaux (D82). Refais la
