...
Avant toute chose, lis dans cet ordre : `README.md`, `docs/description-projet.md`, `docs/invariants.md`, `docs/contraintes.md`, `docs/decisions.md` (**D01 à D34**),
...
- **Virements** : un permanent par couple de comptes ; le flux enregistré est **dérivé** (D57) et
  ...
  que l'ordre exécute et ce que le budget demande (D60).
