...
- **La garde qui juge une PR est celle de la base.** Le job « Validation » exécute la garde et le
  workflow de la branche de base (`main` pour une PR vers `main`) ; il juge le contenu de la PR : ce
