---
name: Besoin
about: Un besoin, et la section que la garde lit au passage en Ready de sa PR
---

## Invariants et contraintes

<!--
Écrite par l'auditeur, sans case (node packages/gardes/cli.mjs demander --base origin/main la prépare).
...
que le porteur constate sur la version de dev après le passage en Ready, avant son « Validé ».
-->
